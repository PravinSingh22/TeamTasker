    ...
    <div className="auth-page">
      ...
      <div className="auth-left">
        <div>
          ...
          <p className="auth-caption">Unlock your team's potential. Let's get to work.</p>
        </div>
      </div>
      <div className="auth-right">
        ...
        <form onSubmit={(e) => { e.preventDefault(); dispatch(clearError()); dispatch(login(form)); }} className="auth-form">
